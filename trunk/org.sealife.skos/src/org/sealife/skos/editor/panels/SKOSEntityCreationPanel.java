...
public class SKOSEntityCreationPanel<T extends OWLEntity> extends OWLEntityCreationPanel {
    ...
    public OWLEntityCreationSet<T> getOWLEntityCreationSet() {
        ...
        try {
            ...
            OWLClassAssertionAxiom skosConceptAx = owlEditorKit.getModelManager().getOWLDataFactory().getOWLClassAssertionAxiom(newInd.getOWLEntity().asOWLIndividual(), conceptClass );
            ...
            if (getSelectedConceptScheme() != null) {
                OWLPropertyAssertionAxiom inSchemeAx = owlEditorKit.getModelManager().getOWLDataFactory().getOWLObjectPropertyAssertionAxiom(newInd.getOWLEntity().asOWLIndividual(), inScheme, getSelectedConceptScheme());
