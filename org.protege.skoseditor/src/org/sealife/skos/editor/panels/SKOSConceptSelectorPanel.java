...
import org.sealife.skos.editor.views.SKOSConceptListViewComponent;
 ...
 * <br>
 */
public class SKOSConceptSelectorPanel extends AbstractSelectorPanel<OWLNamedIndividual> {

    private SKOSConceptListViewComponent viewComponent;

    private Set<OWLOntology> ontologies;

    public SKOSConceptSelectorPanel(OWLEditorKit eKit) {
        this(eKit, true);
    }

    public SKOSConceptSelectorPanel(OWLEditorKit eKit, boolean editable) {
        this(eKit, editable, eKit.getModelManager().getActiveOntologies());
    }

    public SKOSConceptSelectorPanel(OWLEditorKit eKit, boolean editable, Set<OWLOntology> ontologies) {
        this(eKit, editable, ontologies, ListSelectionModel.SINGLE_SELECTION);
    }

    public SKOSConceptSelectorPanel(OWLEditorKit eKit, int selectionMode) {
